...
// TEST CODE REPLY:
//================
var test = "\nHier die weiterleiteteitung:\n> Anfang der weitergeleiteten Nachricht:\n> \n> Von: Lucca Strecker <luccstr@yahoo.de>\n> Betreff: Test Weiteleiten\n> Datum: 9. Juli 2020 um 14:44:28 MESZ\n> An: testemailproject123@gmail.com\n> \n> Hey! This is another Test!\n\n";

console.log(extractEmails(test));

var extractedMail = extractEmails(test);

function extractEmails ( text ){
    return text.match(/([a-zA-Z0-9._-]+@[a-zA-Z0-9._-]+\.[a-zA-Z0-9_-]+)/gi);
    }

var scammerMail = extractedMail[extractedMail.length-1]

console.log(extractedMail[extractedMail.length-1]);
